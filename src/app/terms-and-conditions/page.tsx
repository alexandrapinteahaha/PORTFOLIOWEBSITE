      ...
      <div className="grid gap-12 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="grid gap-0">
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Original artworks</h2>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Prints and editions</h2>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Digital editions and subscriber files</h2>
            <div className="mt-4 text-sm leading-7 text-graphite">
              <p>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Print Club</h2>
            <div className="mt-4 grid gap-4 text-sm leading-7 text-graphite">
              <p>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Intellectual property</h2>
            <div className="mt-4 text-sm leading-7 text-graphite">
              <p>
