      ...
      <div className="grid gap-12 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="grid gap-0">
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Dispatch and handling</h2>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">International shipping and customs</h2>
            <div className="mt-4 grid gap-4 text-sm leading-7 text-graphite">
              <p>
          ...
          <div className="policy-section">
            <h2 className="font-title text-xl font-bold">Returns and damage</h2>
            <div className="mt-4 grid gap-4 text-sm leading-7 text-graphite">
              <p>
